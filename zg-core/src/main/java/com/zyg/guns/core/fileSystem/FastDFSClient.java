package com.zyg.guns.core.fileSystem;

/**
 * Created by yg.zhi on 2018/4/12.
 */
...
//            String CONF_FILENAME = classPath + File.separator +"conf"+File.separator+ "fdfs_client.conf";
            String CONF_FILENAME = "D:\\code"+File.separator+ "fdfs_client.conf";
            ...
            path = "http://"+trackerServer.getInetSocketAddress().getHostString()+":"+trackerServer.getInetSocketAddress().getPort()+"/";
        } catch (Exception e) {
            logger.error(e);
        }
    }
    ...
    public static void main(String[] args) throws IOException{
        File file = new File("D:\\code\\1.jpg");

        String a = uploadFile(new FileInputStream(file),file.getName());
